...
namespace MWMS.Helper{
    ...
    {/// 
        ...
        /// 转换汉字为拼音
        /// </summary>
        /// <param name="chrstr">字符串</param>
        /// <param name="type">0 转换为全部小写 1首字母大写 2只取第一个字母</param>
        /// <returns></returns>
        public static string convert(string chrstr, char type)
        {
            ...
            for (int j = 0; j < nowchar.Length; j++)
            {
                ...
                switch (type)
                {
                    case '1':
                        ...
                        PinYin = PinYin1[0].ToString();
                        for (int n = 1; n < PinYin1.Length; n++)
                        {
                            PinYin += PinYin1[n];
                        }
                        break;
                    case '2':
                        if (PinYin.Length > 0) PinYin = PinYin[0].ToString();
                        else { PinYin = ""; }
                        break;
                }
                returnstr += PinYin;
